...
public class AboutUs extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 90, 30));
        ...
        jTextArea1.setText("Welcome to  Sahyadri Library! \nThis project was developed as part of a Database Management System (DBMS)\n course to demonstrate the application of database concepts in real-world scenarios.");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 150, 720, 110));
